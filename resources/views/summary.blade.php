                                            ...
                                            @foreach ($project->regions as $key => $region)
                                                <tr>
                                                    @if ($key === 0)
                                                        ...
                                                        <td rowspan="{{$project->regions->count()}}">@if (isset($project->contract->planChart))<a href="http://{{$_SERVER['SERVER_NAME']}}/download?path={{substr($project->contract->planChart->path, strripos($project->contract->planChart->path, 'Проекты/')) . $project->contract->planChart->file_name}}">{{$project->contract->planChart->file_name}}</a>@endif</td>
                                                    ...
                                                    @if ($key === 0)
                                                        <td rowspan="{{$project->regions->count()}}">@if (isset($project->contract->decreeScan))<a href="http://{{$_SERVER['SERVER_NAME']}}/download?path={{substr($project->contract->decreeScan->path, strripos($project->contract->decreeScan->path, 'Проекты/')) . $project->contract->decreeScan->file_name}}">{{$project->contract->decreeScan->file_name}}</a>@endif</td>
                                                        <td rowspan="{{$project->regions->count()}}">@if (isset($project->contract->lopFile))<a href="http://{{$_SERVER['SERVER_NAME']}}/download?path={{substr($project->contract->lopFile->path, strripos($project->contract->lopFile->path, 'Проекты/')) . $project->contract->lopFile->file_name}}">{{$project->contract->lopFile->file_name}}</a>@endif</td>
                                                        <td rowspan="{{$project->regions->count()}}">@if (isset($project->contract->contractFile))<a href="http://{{$_SERVER['SERVER_NAME']}}/download?path={{substr($project->contract->contractFile->path, strripos($project->contract->contractFile->path, 'Проекты/')) . $project->contract->contractFile->file_name}}">{{$project->contract->contractFile->file_name}}</a>@endif</td>
                                                        <td rowspan="{{$project->regions->count()}}">@if (isset($project->contract->technicalTask))<a href="http://{{$_SERVER['SERVER_NAME']}}/download?path={{substr($project->contract->technicalTask->path, strripos($project->contract->technicalTask->path, 'Проекты/')) . $project->contract->technicalTask->file_name}}">{{$project->contract->technicalTask->file_name}}</a>@endif</td>
                                                        <td rowspan="{{$project->regions->count()}}">@if (isset($project->contract->projectCharter))<a href="http://{{$_SERVER['SERVER_NAME']}}/download?path={{substr($project->contract->projectCharter->path, strripos($project->contract->projectCharter->path, 'Проекты/')) . $project->contract->projectCharter->file_name}}">{{$project->contract->projectCharter->file_name}}</a>@endif</td>
                                                    @endif
                                                </tr>
                                            @endforeach
                                        @else
                                            <tr>
                                                <td>{{$project->code}}</td>
                                                <td>@if (isset($project->contract->planChart))<a href="http://{{$_SERVER['SERVER_NAME']}}/download?path={{substr($project->contract->planChart->path, strripos($project->contract->planChart->path, 'Проекты/')) . $project->contract->planChart->file_name}}">{{$project->contract->planChart->file_name}}</a>@endif</td>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td>@if (isset($project->cafap))@if (isset($project->cafap->dataTransfer)) <a href="http://{{$_SERVER['SERVER_NAME']}}/download?path={{substr($project->cafap->dataTransfer->path, strripos($project->cafap->dataTransfer->path, 'Проекты/')) . $project->cafap->dataTransfer->file_name}}">{{$project->cafap->dataTransfer->file_name}}</a> @endif @endif</td>
                                                ...
                                                <td>@if (isset($project->cafap))@if (isset($project->cafap->speedMode)) <a href="http://{{$_SERVER['SERVER_NAME']}}/download?path={{substr($project->cafap->speedMode->path, strripos($project->cafap->speedMode->path, 'Проекты/')) . $project->cafap->speedMode->file_name}}">{{$project->cafap->speedMode->file_name}}</a> @endif @endif</td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td>@if (isset($project->contract->decreeScan))<a href="http://{{$_SERVER['SERVER_NAME']}}/download?path={{substr($project->contract->decreeScan->path, strripos($project->contract->decreeScan->path, 'Проекты/')) . $project->contract->decreeScan->file_name}}">{{$project->contract->decreeScan->file_name}}</a>@endif</td>
                                                <td>@if (isset($project->contract->lopFile))<a href="http://{{$_SERVER['SERVER_NAME']}}/download?path={{substr($project->contract->lopFile->path, strripos($project->contract->lopFile->path, 'Проекты/')) . $project->contract->lopFile->file_name}}">{{$project->contract->lopFile->file_name}}</a>@endif</td>
                                                <td>@if (isset($project->contract->contractFile))<a href="http://{{$_SERVER['SERVER_NAME']}}/download?path={{substr($project->contract->contractFile->path, strripos($project->contract->contractFile->path, 'Проекты/')) . $project->contract->contractFile->file_name}}">{{$project->contract->contractFile->file_name}}</a>@endif</td>
                                                <td>@if (isset($project->contract->technicalTask))<a href="http://{{$_SERVER['SERVER_NAME']}}/download?path={{substr($project->contract->technicalTask->path, strripos($project->contract->technicalTask->path, 'Проекты/')) . $project->contract->technicalTask->file_name}}">{{$project->contract->technicalTask->file_name}}</a>@endif</td>
                                                <td>@if (isset($project->contract->projectCharter))<a href="http://{{$_SERVER['SERVER_NAME']}}/download?path={{substr($project->contract->projectCharter->path, strripos($project->contract->projectCharter->path, 'Проекты/')) . $project->contract->projectCharter->file_name}}">{{$project->contract->projectCharter->file_name}}</a>@endif</td>
                                            </tr>
                                        @endif
                                    @endforeach
                                </tbody>
